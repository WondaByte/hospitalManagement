      ...
      <div class="container">
        ...
        <div align="center" style="padding:90px;">
            ...
            <tr style="background-color:grey;" align="center">
                <td stylye="padding:10px; font-size:15px; color:white;">{{$appoints->doctor}}</td>
                <td stylye="padding:10px; font-size:15px; color:white;">{{$appoints->date}}</td>
                <td stylye="padding:10px; font-size:15px; color:white;">{{$appoints->message}}</td>
                <td stylye="padding:10px; font-size:15px; color:white;">{{$appoints->status}}</td>

                <td><a class="bt btn-danger" onclick="return confirm('Do you still wish to DELETE this record')"" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
